package com.example.logisticfreightsystem.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleRuleNotFound(RuleNotFoundException ex, WebRequest request) {
        return buildResponse(HttpStatus.NOT_FOUND, "Rule not found", ex.getMessage(), request, Collections.emptyList());
    }
